...
export var bullet : PackedScene = preload("res://src/Objects/BulletEnemyStatic.tscn")
var state = "shoot"
...
func damage(damage:int):
	print_debug("Enemy static damage " + str(damage))
	animatedSprite.play("buzz")
	animatedSprite2.play("buzz")
	state = "buzz"
	timer.start(1)
...
func _on_Timer2_timeout():
	...
	new_bullet.initialize(Vector2.LEFT, deg2rad(-180))
